...
public class GameState
{
  ...
  public int Player1Streak { get; private set; } = 0;
  public int Player2Streak { get; private set; } = 0;

  /// <summary>
  /// Check the state of the board for a winning scenario
  /// </summary>
  /// <returns>0 - no winner, 1 - player 1 wins, 2 - player 2 wins, 3 - draw</returns>
  private WinState _lastDeclaredWinner = WinState.No_Winner;
  ...
  public WinState CheckForWin()
  {
    ...
    foreach (var scenario in WinningPlaces)
    {
          ...
          TheBoard[scenario[2]] == TheBoard[scenario[3]])
      {
        ...
        if (_lastDeclaredWinner == WinState.No_Winner)
        {
          _lastDeclaredWinner = winner;
  ...
  public void ResetBoard()
  {
    ...
    _lastDeclaredWinner = WinState.No_Winner;
  }
